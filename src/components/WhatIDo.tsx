        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Web Apps & APIs</h4>
              <p>
                Building responsive web applications and clean, reliable APIs
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Explainable AI &amp; Research</h4>
              <p>
                Exploring machine learning projects with a focus on explainable
                AI in healthcare and real-world problem solving.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
